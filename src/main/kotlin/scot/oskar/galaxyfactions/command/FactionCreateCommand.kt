...
class FactionCreateCommand(private val plugin: FactionsPlugin) : AbstractPlayerCommand("createfaction", "Create a faction") {
    ...
    override fun execute(
        ...
        if (existing != null) {
            player.sendMessage(errorMessage("This chunk is already claimed by another faction."))
            return
        }
        ...
        plugin.scope.futureFromSuspend {
            ...
            if (existingFaction != null) {
                player.sendMessage(errorMessage("Faction '$name' already exists."))
            ...
            player.sendMessage(errorMessage("Could not create faction: ${it.message}"))
